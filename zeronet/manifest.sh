...
$DOCKER manifest annotate supersandro2000/zeronet:"$version" supersandro2000/zeronet:armhf-"$version" --os linux --arch arm --variant v7
$DOCKER manifest annotate supersandro2000/zeronet:"$version" supersandro2000/zeronet:arm64-"$version" --os linux --arch arm64 --variant v8
$DOCKER manifest annotate supersandro2000/zeronet:latest supersandro2000/zeronet:amd64-latest --os linux --arch amd64
$DOCKER manifest annotate supersandro2000/zeronet:latest supersandro2000/zeronet:armhf-latest --os linux --arch arm --variant v7
$DOCKER manifest annotate supersandro2000/zeronet:latest supersandro2000/zeronet:arm64-latest --os linux --arch arm64 --variant v8
